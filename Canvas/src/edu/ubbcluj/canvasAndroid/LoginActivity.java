...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((AsyncTask<LoginActivity, Void, Void>) savedSession).execute(new LoginActivity[] { this });
        
        if (!CheckNetwork.isNetworkOnline(this)) {
        	Toast.makeText(this, "Warning! No network connection", Toast.LENGTH_LONG).show();;
        }
	...
	public void sendMessage(View vire) {
    	...
    	//Execute asyncTasc
    	((AsyncTask<String, Void, String>) userDAO).execute(new String[] {PropertyProvider.getProperty("url")});
    }
