...
public class CustomArrayAdapterAnnouncements extends ArrayAdapter<Announcement> {
	...
	public CustomArrayAdapterAnnouncements(Context context, List<Announcement> values) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View rowView = inflater.inflate(R.layout.announcement_row_layout, parent, false);
